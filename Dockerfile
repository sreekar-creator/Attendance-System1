# Stage 1: Build the React Frontend flawlessly using the official Node container
...
# Build the Java server (we tell Maven to intentionally skip its broken frontend plugin)
...
# Copy the massive unified server file
